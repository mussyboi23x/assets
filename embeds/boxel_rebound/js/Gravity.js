(function (window) {
  ...
  function Gravity() {
    ...
    this.set = function (amplitude, duration) {
      ...
      this.pauseDiff = 0;
      if (this.originalAmplitude == null)
    ...
    this.pull = function () {
      ...
      this.x =
        this.timeDiff /
          (this.duration / window.Game.speed / window.Game.gravityMultiplier) +
        this.startX;
    ...
    this.forceDirection = function () {
      return this.isFalling() ? 1 : -1;
    };
    this.setPauseDiff = function (pauseDiff) {
      this.pauseDiff = pauseDiff;
    };
